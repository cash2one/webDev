...
//动画   
	...
	$('.one').click(function(){
		...
		$('.m_cont1').stop().animate({'left':0},{'easing':'swing','duration':1500});
	...
	$('.two').click(function(){
		...
		$('.m_cont2').stop().animate({'left':0},{'easing':'swing','duration':1500});
	...
	$('.thr').click(function(){
		...
		$('.m_cont3').stop().animate({'left':0},{'easing':'swing','duration':1500});
	...
	$('.four').click(function(){
		...
		$('.m_cont4').animate({'left':0},{'easing':'swing','duration':1500});
	...
	$('.five').click(function(){
		...
		$('.m_cont5').stop().animate({'left':0},{'easing':'swing','duration':1500});
	...
	$('.six').click(function(){
		...
		$('.m_cont6').stop().animate({'left':0},{'easing':'swing','duration':1500});
	...
	$('.sev').click(function(){
		...
		$('.m_cont7').stop().animate({'left':0},{'easing':'swing','duration':1500});
