...
<body class="indexBody">
	...
	<section class="main" id="main">
		...
		<div class="m_nav">
			<ul>
				<li><a href="product.asp">厨房系列</a></li>
				<li><a href="pBook.asp">书房系列</a></li>
				<li><a href="pRoom.asp">卧室系列</a></li>
				<li style="border-right:1px solid #fff;"><a href="pRest.asp">餐厅系列</a></li>
			</ul>
		</div>
		<!--底部导航...-->
		<!--内容展示-->
		<div class="m_cont" id="m_cont1">
			<div class="m_cont_h" ><img src="imgs/1.png"/ class="m_cont_h1"><img src="imgs/capt.png"/ class="m_cont_h2"></div>
			<ul class="m_cont_lis">
