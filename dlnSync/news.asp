...
<body id="news">
	...
	<div class="option" id="option">
		<a href="news.asp"><span>企业动态</span></a>
		<a href="nSale.asp"><span>促销信息</span></a>
	</div>
	<!--动态-->
	<section id="box" class="box">
		<!--企业动态-->
		<div class="n_state" id="state">
			<div class="n_tab">
				<a href="n_detail.asp" class="link" onactivate="return false;">
					<div class="n_tab_img" style="background-image:url(imgs/news_1.png)"></div>
					<div class="n_tab_det">
				...
				<a href="n_detail.asp" class="link">
					<div class="n_tab_img" style="background-image:url(imgs/news_1.png)"></div>
					<div class="n_tab_det">
						<date>2017/05/26</date>
						<span>企业动态</span>
