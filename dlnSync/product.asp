...
<body class="p_body">
	...
	<article class="p_artc">
		<!--菜单-->
		<!--#include file="pHeader.asp"-->
		<!--菜单...-->
		<section class="p_box" id="p_box">
			<div class="p_cont" id="p_cont1">
				<ul>
					<li><a href="p_det.asp"><img src="imgs/1_1_1.png"/><span>筑巢指南-厨房系列</span></a></li>
					<li><a href="p_det.asp"><img src="imgs/1_1_1.png"/><span>筑巢指南-厨房系列</span></a></li>
					<li><a href="p_det.asp"><img src="imgs/1_1_1.png"/><span>筑巢指南-厨房系列</span></a></li>
					<li><a href="p_det.asp"><img src="imgs/1_1_1.png"/><span>筑巢指南-厨房系列</span></a></li>
					<li><a href="p_det.asp"><img src="imgs/1_1_1.png"/><span>筑巢指南-厨房系列</span></a></li>
	 	...
	 	<!--翻页-->
	   	<aside class="page" id="productPage">
	   		<ul>
	   			<div>上一页</div>
	   			<li>1</li>
	   			<li>2</li>
